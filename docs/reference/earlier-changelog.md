# Earlier change ledger — historical reference

These entries predate the verified learning-room update. Version dates, performance improvements and deployment claims below have not been established by the current tests. Use the [current change record](../../ChangeLog.md) for checked behavior.
